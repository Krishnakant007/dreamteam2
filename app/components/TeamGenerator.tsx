...
export const useTeamGenerator = ({ 
  ...
  const getPredefinedTeam = (): GeneratedTeam | null => {
    ...
    // Add this new condition for match ID 115318
    if (matchId === "115318") {
      const players = [
        findPlayer("Prabhsimran Singh-C"),
        findPlayer("Ayush Badoni-Vc"),
        findPlayer("Arshdeep Singh"),
        findPlayer("Abdul Samad"),
        findPlayer("Shreyas Iyer"),
        findPlayer("Shashank Singh"),
        findPlayer("Azmatullah Omarzai"),
        findPlayer("Josh Inglis"),
        findPlayer("Marco Jansen"),
        findPlayer("Yuzvendra Chahal"),
        findPlayer("Digvesh Singh")
      ];
    
      const captain = players.find(p => p.name.includes("Prabhsimran")) || players[0];
      const viceCaptain = players.find(p => p.name.includes("Badoni")) || players[1];
      ...
      return {
        ...
        viceCaptain,
        substitutes: [],
        teamName: "Expert's Choice (115318)",
        team1ShortName: team1.shortName || 'T1',
        team2ShortName: team2.shortName || 'T2',
        riskLevel,
        matchId,
