...
//         role: name.includes('-C') ? 'Batsman' : 
//               name.includes('-Vc') ? 'Batsman' : 
//               name.includes('Rashid Khan') ? 'Bowling Allrounder' :
//               name.includes('Prasidh Krishna') ? 'Bowler' :
//               name.includes('Jofra Archer') ? 'Bowler' :
//               name.includes('Maheesh Theekshana') ? 'Bowler' :
//               name.includes('Sandeep Sharma') ? 'Bowler' :
//               name.includes('Riyan Parag') ? 'Batting Allrounder' :
//               'Batsman'
//       };
//     };
...
//       findPlayer("Rashid Khan"),
//       findPlayer("Prasidh Krishna"),
//       findPlayer("Yashasvi Jaiswal"),
//       findPlayer("Vaibhav Suryavanshi-C"),
//       findPlayer("Riyan Parag"),
//       findPlayer("Jofra Archer"),
//       findPlayer("Maheesh Theekshana"),
//       findPlayer("Sandeep Sharma")
//     ];

//     const captain = players.find(p => p.name.includes("Vaibhav Suryavanshi")) || players[0];
//     const viceCaptain = players.find(p => p.name.includes("Shubman Gill")) || players[1];
