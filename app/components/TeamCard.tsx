...
// //         <div className="mb-3 bg-white p-2 rounded border border-gray-200">
// //   <div className="flex justify-between text-sm mb-1 text-gray-800">
// //     <span>{team.team1ShortName || 'CSK'}: {team.team1Count || 7}</span>
// //     <span>{team.team2ShortName || 'KKR'}: {team.team2Count || 4}</span>
// //   </div>
...
//   // Calculate team counts correctly
//   const team1Count = team?.players?.filter(p => 
//     p.teamShortName === team?.team1ShortName
//   ).length || 0;
...
//         <div className="mb-3 bg-white p-2 rounded border border-gray-200">
//           <div className="flex justify-between text-sm mb-1 text-gray-800">
//             <span>{team?.team1ShortName || captain.teamShortName}: {team1Count}</span>
//             <span>{team?.team2ShortName || opponentTeamName}: {team2Count}</span>
//           </div>
//           <div className="flex justify-between items-center mt-1">
//             <div className="flex flex-wrap gap-1 text-xs">
...
// // DammGood working code , no girls
